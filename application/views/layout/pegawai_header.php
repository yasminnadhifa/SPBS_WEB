        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a href="<?= base_url('Pegawai/logout') ?>" class="dropdown-item has-icon text-danger">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?= base_url('Pegawai/dashboard') ?>">
                <div class="test"><i class="fas fa-th-large test"></i>  <span>Dashboard</span> </div>
              </a></li>
            <li class="menu-header">Starter</li>

            <li><a class="nav-link" href="<?= base_url('Pegawai/berkas') ?>"><i class="far fa-square"></i> <span>Berkas</span></a></li>    

            <li><a class="nav-link" href="<?= base_url('Pegawai/pengaduan') ?>"><i class="far fa-square"></i> <span>Pengaduan</span></a></li>  
